...
8. Run application (or if you have vhost or vps, then just skip remaining steps and go directly to http://apidev.policylead.eu:83/)
...
## [Documentation](http://apidev.policylead.eu:83//docs.html)

## [Postman examples](http://apidev.policylead.eu:83//postman/collection.json)
